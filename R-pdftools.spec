...
Version  : 3.3.2
Release  : 49
URL      : https://cran.r-project.org/src/contrib/pdftools_3.3.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/pdftools_3.3.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666022269
