...
Version  : 3.3.1
Release  : 48
URL      : https://cran.r-project.org/src/contrib/pdftools_3.3.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/pdftools_3.3.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664984909
