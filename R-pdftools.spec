...
Version  : 2.0
Release  : 3
URL      : https://cran.r-project.org/src/contrib/pdftools_2.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/pdftools_2.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1544547231
