...
Version  : 3.0.1
Release  : 31
URL      : https://cran.r-project.org/src/contrib/pdftools_3.0.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/pdftools_3.0.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622845021
