...
Version  : 1.8
Release  : 1
URL      : https://cran.r-project.org/src/contrib/pdftools_1.8.tar.gz
Source0  : https://cran.r-project.org/src/contrib/pdftools_1.8.tar.gz
Summary  : Text Extraction, Rendering and Converting of PDF Documents
Group    : Development/Tools
License  : MIT
Requires: R-pdftools-lib
Requires: R-Rcpp
...
export LANG=C
export SOURCE_DATE_EPOCH=1536417943
